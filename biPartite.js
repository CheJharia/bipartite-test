!function(){
	var bP={};	
	var b=30, bb=150, height=900, buffMargin=5, minHeight=14;
...
"#FFED6F", "#66C2A5", "#FC8D62", "#8DA0CB", "#E78AC3", "#A6D854", "#FFD92F", "#E5C494", "#B3B3B3",
...
"#1B9E77", "#D95F02"];
	...
	function drawHeader(header, id){
		...
		[0,1].forEach(function(d){
			...
			h.append("text").text("Count").attr("x", (c2[d] + 1))
				.attr("y", -5).style("fill","grey");
			
			h.append("line").attr("x1",c1[d]-10).attr("y1", -2)
				.attr("x2",c3[d] + 180).attr("y2", -2).style("stroke","black")
